...
public class ConversationsByUIListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if(viewType==viewTypeSenderMessage) {
            ...
            viewHolder = new com.example.o2chatsdk.adapters.ConversationsByUIListAdapter.ViewHolder(view);
        }
            ...
            viewHolder= new com.example.o2chatsdk.adapters.ConversationsByUIListAdapter.ViewHolderForChatImagesAndFile(view);
        }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        if (holder.getItemViewType()==viewTypeImageSenderMessage || holder.getItemViewType() == viewTypeImageReceiverMessage) {
            ...
            {
                com.example.o2chatsdk.adapters.ConversationsByUIListAdapter.ViewHolderForChatImagesAndFile viewHolderForChatImagesAndFile = (com.example.o2chatsdk.adapters.ConversationsByUIListAdapter.ViewHolderForChatImagesAndFile) holder;
                    ...
                    if(!conversation.files.get(0).url.isEmpty() && conversation.files.get(0).type!=null){
                        if (conversation.files.get(0).type.equalsIgnoreCase("zip") || conversation.files.get(0).type.equalsIgnoreCase("application/zip")){
                            ...
                            if (isPlaying && playingPosition == position) {
                                ...
                                ((com.example.o2chatsdk.adapters.ConversationsByUIListAdapter.ViewHolderForChatImagesAndFile) holder).audioSeekBar.setProgress(0);
                            }
...
//                if (conversation.files.get(0).type.equalsIgnoreCase("image/jpeg") || conversation.files.get(0).type.equalsIgnoreCase("image/png") || conversation.files.get(0).type.equalsIgnoreCase("image/jpg")) {
            ...
            com.example.o2chatsdk.adapters.ConversationsByUIListAdapter.ViewHolder vh = (com.example.o2chatsdk.adapters.ConversationsByUIListAdapter.ViewHolder) holder;
    ...
    private void startPlayback(com.example.o2chatsdk.adapters.ConversationsByUIListAdapter.ViewHolderForChatImagesAndFile viewHolderForChatImagesAndFile, SeekBar audioSeekBar, String audioUrl) {
    ...
    private void startPlaybackFromWidget(com.example.o2chatsdk.adapters.ConversationsByUIListAdapter.ViewHolderForChatImagesAndFile viewHolderForChatImagesAndFile, SeekBar audioSeekBar, String audioUrl, String conversationUUIDandID, boolean isDuration) {
        stopPlayback(); // Stop previous playback if any
        ...
        if (localFile.exists()) {
            ...
            downloadFile(audioUrl, localFilePath, new com.example.o2chatsdk.adapters.ConversationsByUIListAdapter.DownloadCallback() {
                @Override
    ...
    private void playAudioFile(String localFilePath, com.example.o2chatsdk.adapters.ConversationsByUIListAdapter.ViewHolderForChatImagesAndFile viewHolderForChatImagesAndFile, SeekBar audioSeekBar) {
        mediaPlayer = new MediaPlayer();
        try {
    ...
    private void showLoader(com.example.o2chatsdk.adapters.ConversationsByUIListAdapter.ViewHolderForChatImagesAndFile viewHolderForChatImagesAndFile) {
    ...
    private void hideLoader(com.example.o2chatsdk.adapters.ConversationsByUIListAdapter.ViewHolderForChatImagesAndFile viewHolderForChatImagesAndFile) {
        ((Activity) mcontex).runOnUiThread(() -> {
    ...
    private void downloadFile(String fileUrl, String localPath, com.example.o2chatsdk.adapters.ConversationsByUIListAdapter.DownloadCallback callback) {
        new Thread(() -> {
    ...
    private void getAudioDuration(String filePath, com.example.o2chatsdk.adapters.ConversationsByUIListAdapter.DurationCallback callback) {
